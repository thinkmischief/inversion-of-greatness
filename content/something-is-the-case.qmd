...
**Doubles as the section's backstop:** a state with no T, S, Φ is no state at all, the ∅-incoherence every other Move leans on, developed in its own right at §3.2.6.
