...
1. The lift from "operative in this case" to "necessary" is not made here: it is borrowed from §3.3.4 (conceivability), the modal triconditional, or the ∅-result (§3.2.6).
