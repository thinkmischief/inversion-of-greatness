...
- **No stable zero-extension state can persist anywhere in Nature.** *Domain: Cosmology · Source: §7.6 · Status: —.*
  - Confirmation evidence: Physics reports the instability not as independent confirmations but as several directions sorting into three kinds of pressure (§7.6.2); the mathematical breakdown (curvature divergence, geodesic incompleteness) is the explanandum itself, not a separate witness
  - Falsifies if: Any framework confirms a stable singularity at zero extension
- **Information cannot be permanently destroyed at a singularity** *(downstream of the modal preclusion, not a strict deductive consequence of the proof; see §7.6.3).* *Domain: Cosmology · Source: §§7.6, 7.6.3 · Status: —.*
...
- **Past has no first moment; Time has no first moment.** *Domain: Cosmology · Source: §§2.1.3, 2.2, 7.6 · Status: —.*
...
- **First life must be autotrophic.** *Domain: Origin of Life · Source: §7.8 · Status: —.*
...
- **First energy source cannot be photic.** *Domain: Origin of Life · Source: §§7.8, 7.8.2 · Status: —.*
...
- **First heritable medium combines catalysis with template-readability in a single molecular class.** *Domain: Origin of Life · Source: §7.8.2 · Status: —.*
...
- **Three coupled cycles (production, energy, information) co-emerge.** *Domain: Origin of Life · Source: §7.8.2 · Status: —.*
...
- **Time and Space compose into a single manifold (Spacetime).** *Domain: Structure of Physics · Source: §7.5 (T ↔ S) · Status: —.*
...
- **Substance does not occur without spatial extent (Field).** *Domain: Structure of Physics · Source: §7.5 (S ↔ Φ) · Status: —.*
...
- **Conserved quantities cannot arise from or vanish into nothing (Conservation).** *Domain: Structure of Physics · Source: §7.5 (T ↔ Φ) · Status: —.*
...
- **All three axes bind into one symmetric structure.** *Domain: Structure of Physics · Source: §7.5 (T ↔ S ↔ Φ) · Status: —.*
...
- **Cosmological history is cyclic at the macro-scale.** *Domain: Cosmology · Source: §7.6 · Basis: Abductive · Status: —.*
...
- **Each cycle traces the same macro-trajectory (expansion, structure formation, compression, return).** *Domain: Cosmology · Source: §7.6 · Basis: Abductive · Status: —.*
  - Confirmation evidence: Modal Invariance (§2.1.7) plus macro-scale transmission across the bounce
  - Falsifies if: Macro-scale invariance across cycles falsified (e.g. cycles without stars or without observers)
- **Type–token coupling is a real seam, not an artifact of incomplete physics.** *Domain: QM & Type/Token · Source: §7.7 · Basis: Abductive · Status: —.*
...
- **Token outcomes are not pre-fixed by the type.** *Domain: QM & Type/Token · Source: §7.7 · Basis: Empirical · Status: —.*
...
- **First energy source is chemical (redox).** *Domain: Origin of Life · Source: §7.8.2 · Basis: Abductive · Status: —.*
  - Confirmation evidence: Alkaline hydrothermal vent chemiosmosis (Martin and Russell 2007; Lane 2015); reconstructed LUCA metabolism (Weiss et al. 2016), the abductive best fit per §7.8.2
  - Falsifies if: First life captures energy via mechanism not reducible to redox chemistry
- **Life is the favored attractor under sustained energy gradient.** *Domain: Origin of Life · Source: §§7.8, 7.8.1, 7.8.4 · Basis: Abductive · Status: —.*
  - Confirmation evidence: Schrödinger 1944; Prigogine and Nicolis 1977; England 2013; Earth's early-emergence datum (life within ∼100–700 Myr of habitability, Mojzsis et al. 1996; Bell et al. 2015); the favoring reading is abductively supported by the early-emergence datum, not empirically confirmed (§7.8.4)
  - Falsifies if: Sustained gradient + suitable conditions + sufficient time → no life formation
- **Life elsewhere wherever sustained chemical disequilibrium holds.** *Domain: Origin of Life · Source: §§7.8.4, 2.1.7 · Basis: Abductive · Status: —.*
  - Confirmation evidence: Modal Invariance (§2.1.7) plus chemoautotrophic-origin prediction. Targets: Mars (past), Europa (subsurface ocean with likely seafloor hydrothermal activity), Enceladus (confirmed subsurface vents, Hsu et al. 2015), Titan (alternative chemistry under sustained disequilibrium)
...
- **Consciousness obtains wherever dissipative self-maintenance reaches recursive depth that includes the modeling itself** *(modal kind: constitutive identification).* *Domain: Consciousness · Source: §§7.8, 8 · Basis: Abductive · Status: —.*
...
- **Consciousness elsewhere wherever the recursion threshold is reached** *(modal kind: necessary possibility).* *Domain: Consciousness · Source: §§2.4, 7.8 · Basis: Abductive · Status: —.*
...
- **Bénard cells and hurricanes lack vantage; bacteria have minimal vantage** *(modal kind: constitutive).* *Domain: Consciousness · Source: §7.8 · Basis: Abductive · Status: —.*
...
- **Any sufficiently deep self-modeling system reliably reports a hard problem; report strength tracks reflective depth (the meta-problem discharge).** *Domain: Consciousness · Source: §8.3 · Basis: Abductive · Status: —.*
...
- **Any sufficiently deep self-modeling lineage produces the same structural registers (register-universality), not the same cultural particulars.** *Domain: Consciousness · Source: §8.15 · Basis: Abductive · Status: —.*
...
- **Primordial gravitational-wave spectrum and non-Gaussianity distinguishable from slow-roll inflation.** *Domain: Cosmology · Source: §7.6 · Status: Active.*
...
- **CMB Hawking-point anomalies as previous-aeon signatures.** *Domain: Cosmology · Source: §7.6 · Status: Contested.*
...
- **Local-deterministic conjunction fails at the token level.** *Domain: QM & Type/Token · Source: §7.7 · Status: Confirmed.*
...
- **Penrose-Diósi gravity-induced collapse predicts a mesoscopic threshold.** *Domain: QM & Type/Token · Source: §7.7 · Status: Active.*
...
- **Near-death experiences are integrative-flow destabilization, not departure.** *Domain: Consciousness · Source: §8.7 · Status: —.*
...
- **Stable singularity (permanent zero extension).** *Source: §7.6.*
  - Why foreclosed: Permanent zero extension is absolute nothingness under cosmological description; ∅ is not anywhere Nature can persist (§2.8; §2.8.5)
- **Permanent information destruction at singularities.** *Source: §7.6.*
...
- **Block-universe fatalism (eternalism → fatalism).** *Source: §7.7.*
  - Why foreclosed: Eternalism names the reality of the dimension; fatalism additionally requires that passage through it be illusory. §7.2 preserves passage as a genuinely directional flow
- **Strict Laplacean determinism (type fixes token exhaustively).** *Source: §7.7.*
  - Why foreclosed: Type does not fix token; ruled out by composition argument and by Bell-violation empirical record
- **Strict superdeterminism.** *Source: §7.7.*
...
- **Strict Nietzschean eternal recurrence (token-level).** *Source: §§7.6, 7.7.*
...
- **Type-level fine-tuning (calls for external selector).** *Source: §§2.7.3, 7.7.*
...
- **Agency as readout of pre-settled computation.** *Source: §7.7.*
...
- **Strong panpsychism (consciousness all the way down).** *Source: §§7.8, 8.*
...
- **Sequential cycle emergence (metabolism-first or replicator-first).** *Source: §7.8.2.*
