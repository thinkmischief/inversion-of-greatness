...
1. And if those relations are *borne* rather than a bare Humean mosaic of labels, something sustains them (Φ), the step the bare mosaic contests, which this Move inherits rather than earns, the anti-Humean Φ being earned downstream at §2.4.8 (the causal-exchange derivation) and §4.1.4 (the Humean reading).
...
*Dependency.* §1.3 and §1.4 supply the ordinary triad; Chapter 2 supplies the formal T/S/Φ notation. The section handles primitive thisness (Adams) and mereological nihilism (van Inwagen, Dorr); the anti-Humean Φ the bare mosaic (Lewis) denies is earned at §4.1.4, on the causal-exchange derivation of Φ at §2.4.8. It defends the conclusion against a counterexample rather than proving it single-handed.
