...
*Dependency.* §1.3, §1.4; the ersatzist lock leans on the ∅-incoherence floor (§3.2.1 / §3.2.6, defended airtight at §3.3.4). The load-bearing joint is closed by reduction to the ∅-floor; the only residual is the chapter's by-design □S spatial-type seam (§3.5.3 → §4.2), which does not cap.
