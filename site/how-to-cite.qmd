...
```plain text
Procyon. YYYY. The Inversion of Greatness. https://doi.org/10.5281/zenodo.21733264
```

### Archived snapshot (v0.1.0, 2026-08-01)

```plain text
Procyon. 2026. The Inversion of Greatness (working manuscript, version of 2026-08-01). https://doi.org/10.5281/zenodo.21733265
```

## Persistent identifiers

- **Concept DOI** (work-level, latest version): [10.5281/zenodo.21733264](https://doi.org/10.5281/zenodo.21733264)
- **Version DOI** (v0.1.0, 2026-08-01): [10.5281/zenodo.21733265](https://doi.org/10.5281/zenodo.21733265)
